...
1. 입시 일정·제도가 바뀌었는가 (수시·정시 일정, 전형 신설·폐지)
2. 특정 대학의 모집요강이 바뀌었는가 (정원, 신설 학과·전형)
...
5. 특정 대학의 취업률·정원·구조가 바뀌었는가 (졸업생 취업률 변화, 통폐합, 정원 조정, 재정지원사업 선정 — "대학 소식" 토픽과 짝을 맞추기 위해 추가. 취업률은 대학 선택의 중요 지표라는 판단)
...
중요도_기준:
  - "입시 일정·제도가 바뀌었는가 (수시·정시 일정, 전형 신설·폐지)"
  - "특정 대학의 모집요강이 바뀌었는가 (정원, 신설 학과·전형)"
  - "교육부·KICE가 정책을 발표했는가 (고교학점제, 수능 개편 등)"
  - "입시 지원·합격 관련 통계가 갱신되었는가 (지원율, 경쟁률, 충원율, 합격선 등 대입 결과 지표. 대출·취업 등 입시와 무관한 일반 통계는 제외)"
  - "특정 대학의 취업률·정원·구조가 바뀌었는가 (졸업생 취업률 변화, 통폐합, 정원 조정, 재정지원사업 선정)"
